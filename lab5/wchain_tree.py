...
def write_result(file_in, file_out):
    graph = Graph()
...
if __name__ == '__main__':
    # First test
    write_result("example_one.in", "example_one.out")

    # Second test
    write_result("example_two.in", "example_two.out")

    # Last test
    write_result("example_three.in", "example_three.out")
